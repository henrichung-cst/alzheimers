...
function getScopedAttribution(kinaseId, filter) {
  ...
  for (let j = 0; j < AI.kinase_id.length; j++) {
    ...
    out.push({
      ...
      motif_peers_detected:    AI.motif_peers_detected    ? AI.motif_peers_detected[j]    : null,
      motif_peers_informative: AI.motif_peers_informative ? AI.motif_peers_informative[j] : null,
      motif_peer_key:          AI.motif_peer_key          ? AI.motif_peer_key[j]          : null,
      motif_peer_cohort:       AI.motif_peer_cohort       ? AI.motif_peer_cohort[j]       : "tcell",
