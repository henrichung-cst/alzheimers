...
|------|---------|-----------|
| `atlas.py` | Download SEA-AD MTG Nebula h5ads + WMB-10Xv3 log2 matrices; gene-list helpers. Was `alz/atlas_reference.py`. | `python alz/reference/atlas.py --run` |
...
| `human_expression.py` | Cross-cohort human expression aggregates (SEA-AD supertype, HBCA class). Was `alz/human_reference_expression.py`. | `python alz/reference/human_expression.py` |
