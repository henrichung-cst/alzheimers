...
echo "[run_mukesh_perdonor] running python -m alz.cohorts.mukesh.mea --track both" | tee -a "$LOG"

pixi run python -m alz.cohorts.mukesh.mea --track both 2>&1 | tee -a "$LOG"
