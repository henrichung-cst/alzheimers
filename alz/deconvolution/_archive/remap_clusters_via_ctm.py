...
- renamed_sobj_obs.csv  : per-nucleus barcode -> Idents (46 New_ID) +
  ...
  via alz/deconvolution/extract_yuyu_obs.R.
...
- alz/deconvolution/yuyu_46_to_wmb_class_v2.csv : hard plurality assignment
  with audit columns (plurality_fraction, n_nuclei, second-best class).
- alz/deconvolution/yuyu_46_to_wmb_class_soft.csv : full mass matrix
  (46 clusters x 34 WMB classes), row-normalized fractions.

Usage:  pixi run python alz/deconvolution/remap_clusters_via_ctm.py
"""
