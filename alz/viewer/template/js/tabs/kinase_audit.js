...
function _diagnoseRawAbsence(ctx, rawRow) {
  ...
  if (!meaRaw.length) {
    return {kind:"file_missing", note:"No raw-phospho MEA loaded for this kinase. Run <code>pixi run python alz/kinase_mechanism.py</code> to generate <code>mea_raw_phospho.csv</code> (and <code>mea_raw_phospho_pY.csv</code> for tyrosine kinases)."};
  }
