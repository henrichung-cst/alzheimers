...
Usage:
  ...
  python code/runners/supporting/extract_wmb_gene_subset.py --dry-run
"""
...
def _build_gene_union():
    ...
    if os.path.exists(gene_list_path):
        ...
        print("  Run: python code/data_ingest.py --phospho-match")
...
def extract_subsets(dry_run=False):
    ...
    for ri, file_key in enumerate(config.WMB_ALL_REGION_KEYS, 1):
        ...
        if not os.path.exists(region_path):
            ...
            print(f"    Run: bash code/runners/supporting/decompress_atlas_cache.sh WMB")
            continue
    ...
    print(f"  bash code/runners/supporting/compress_atlas_cache.sh")
