...
$PYTHON code/supplementary/fdr_stringent.py --run 2>&1 | tee -a "$LOG"

# --- Q1: Threshold sensitivity ---
note "Running Q1: Threshold sensitivity analysis"
$PYTHON code/supplementary/threshold_sensitivity.py --run 2>&1 | tee -a "$LOG"

# --- Q2: Aggregation robustness ---
note "Running Q2: Aggregation robustness analysis"
$PYTHON code/supplementary/aggregation_robustness.py --run 2>&1 | tee -a "$LOG"

# --- Q5: Parent protein QC ---
note "Running Q5: Parent protein QC"
$PYTHON code/supplementary/parent_protein_qc.py --run 2>&1 | tee -a "$LOG"
