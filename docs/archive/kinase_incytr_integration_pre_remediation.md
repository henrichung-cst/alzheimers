> **Archived 2026-05-09.** This document describes the legacy shadow-fork integration architecture (`alz/integration/{wrappers,adapters,sidecar,tests}/` + `incytr_runtime.{sh,R}`) that was relocated to `~/Projects/work/incytr_integration_archive/` on 2026-05-08. Forward-looking architecture lives in `docs/incytr_remediation_plan.md`; the in-tree successor doc is `docs/integrations/kinase_incytr_integration.md`.
